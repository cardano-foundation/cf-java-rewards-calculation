  ...
  public static TreasuryValidationResult calculateTreasuryForEpoch(int epoch, DataProvider dataProvider) {
    ...
    if (dataProvider instanceof JsonDataProvider) {
      ...
      treasuryCalculationResult = TreasuryCalculation.calculateTreasuryInEpoch(epoch, protocolParameters, adaPotsForPreviousEpoch, epochInfo,
              ...
              epochValidationInput.getRegisteredAccountsUntilNow(), BigInteger.ZERO);
    } else {
      ...
      treasuryCalculationResult = TreasuryCalculation.calculateTreasuryInEpoch(epoch, protocolParameters, adaPotsForPreviousEpoch, epochInfo, rewardAddressesOfRetiredPoolsInEpoch, mirCertificates, deregisteredAccountsOnEpochBoundary, registeredAccountsUntilNow, BigInteger.ZERO);
    }
